...
def test_create_scheduled_inquiry_when_called_with_inquiry_id_that_doesnt_exist_should_return_400(
...
def test_create_scheduled_inquiry_when_called_with_inquiry_id_that_exists_should_return_200(
    client: TestClient, superuser_token_headers: dict[str, str], db: Session
) -> None:
    inquiry_in = InquiryCreate(text="I am a test inquiry")
